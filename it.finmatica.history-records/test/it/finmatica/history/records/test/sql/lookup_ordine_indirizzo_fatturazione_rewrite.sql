...
FROM C_BPartner_Location_HST C_BPartner_Location
...
AND ((select XHSTX.dateordered from c_order XHSTX where XHSTX.c_order_id = 123) between C_BPartner_Location.HSTFromDate and C_BPartner_Location.HSTToDate)
ORDER BY 3

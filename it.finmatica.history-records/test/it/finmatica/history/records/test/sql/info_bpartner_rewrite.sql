...
AND ((select XHSTX.dateordered from c_order XHSTX where XHSTX.c_order_id = 1007279) between l.HSTFromDate and l.HSTToDate)
LEFT OUTER
JOIN AD_User c ON
(
...
AND ((select XHSTX.dateordered from c_order XHSTX where XHSTX.c_order_id = 1007279) between bp.HSTFromDate and bp.HSTToDate)
ORDER BY bp.Value

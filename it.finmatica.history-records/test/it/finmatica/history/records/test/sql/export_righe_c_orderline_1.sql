...
PriceCost,
IsActive,
(select productType from M_Product where M_Product.M_Product_ID = C_OrderLine.M_Product_ID) AS ProductType,
C_Currency_ID,
DateInvoiced,
C_OrderLine_ID,
PriceLimit,
...
RRStartDate,
Ref_OrderLine_ID,
(SELECT isforcedmnt from m_product where m_product.m_product_id=c_orderline.m_product_id) AS IsProductForcedMnt,
RRAmt,
AD_Client_ID,
AD_Org_ID,
C_Order_ID,
